...
@Component({
  selector: 'app-bu-head-dashboard',
  templateUrl: './bu-head-dashboard.component.html',
  styleUrls: ['./bu-head-dashboard.component.css']
})
export class BuHeadDashboardComponent {
  ...
  constructor(private dialog: MatDialog, private http: HttpClient,
    private authService: MsalService, private dashBoardService: DashBoardServiceService) { }
