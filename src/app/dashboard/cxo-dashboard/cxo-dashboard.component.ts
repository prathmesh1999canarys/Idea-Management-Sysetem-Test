...
@Component({
  ...
  styleUrls: ['./cxo-dashboard.component.css']
})
export class CxoDashboardComponent {
  ...
  getCxoRejection() {
    this.dashBoardService.getCxoRejectionReason().subscribe((response: any) => {
      ...
      this.getRejectionPie(rejectionReason, rCount);
    });
  }
  
  getRejectionPie(rejectionReason: Array<any>, rCount: Array<any>) {
